...
const About = () => (
  <section className="paddingsrelative z-10">
    ...
    >
      ...
      >
        <span className="boldWhite">Metaverse </span>
        ...
        <span className="boldWhite"> madness of the metaverse </span>
        of today using only 
        <span className="boldWhite"> VR </span>
        devices you can easily explore the
        metaverse world you want, turn your dreams into reality. Let's 
        <span className="boldWhite"> explore </span>

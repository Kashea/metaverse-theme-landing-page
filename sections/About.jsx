...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        <span className={styles.boldWhite}>Metaverse </span>
        ...
        <span className={styles.boldWhite}> madness of the metaverse </span>
        of today using only 
        <span className={styles.boldWhite}> VR </span>
        devices you can easily explore the
        metaverse world you want, turn your dreams into reality. Let's 
        <span className={styles.boldWhite}> explore </span>
